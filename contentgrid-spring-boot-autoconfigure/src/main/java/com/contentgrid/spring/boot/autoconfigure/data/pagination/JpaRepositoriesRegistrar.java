...
import com.contentgrid.spring.data.pagination.jpa.ContentGridPaginationJpaRepositoryFactoryBean;
...
class JpaRepositoriesRegistrar extends AbstractRepositoryConfigurationSourceSupport {
    ...
    @EnableJpaRepositories(repositoryFactoryBeanClass = ContentGridPaginationJpaRepositoryFactoryBean.class)
