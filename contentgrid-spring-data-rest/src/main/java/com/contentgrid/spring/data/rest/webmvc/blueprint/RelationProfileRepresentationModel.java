...
public class RelationProfileRepresentationModel extends RepresentationModel<RelationProfileRepresentationModel> {
    ...
    public static RelationProfileRepresentationModel from(
            RelationModel relation) {
        return RelationProfileRepresentationModel.builder()
                .name(relation.getName())
                .title(relation.getTitle())
                .description(relation.getDescription())
                .manySourcePerTarget(relation.isManySourcePerTarget())
                .manyTargetPerSource(relation.isManyTargetPerSource())
