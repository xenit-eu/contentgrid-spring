...
public class EntityProfileRepresentationModel extends RepresentationModel<EntityProfileRepresentationModel> {
    ...
    @JsonIgnore
    @With
    private final Collection<RelationProfileRepresentationModel> relations;
